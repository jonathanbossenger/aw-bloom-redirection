...
Installing "AW Bloom Redirection" can be done either by searching for "AW Bloom Redirection" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
